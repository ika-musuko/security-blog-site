...
def verify_login_prepared(user_id: str, password: str):
    ...
    try:
        with conn.cursor() as cursor:
            # see if the user_id and password match using a PREPARED statement
            statement = 'SELECT user_id FROM insecure_users WHERE user_id=%s AND password=%s;'
